...
# 计算某一属性的信息增益
def infoGainCalc(xfeature, y, entD, is_continuous = False):
...
if __name__ == '__main__':
    ...
    # # 理解pd.value_counts.index
    # print(pd.value_counts(y).index[0])
    # features = X.columns
    # print(features[0])
    # uniValue = X[features[0]].unique()
    # print(uniValue)
    # for value in uniValue:
    #     # 取出当前属性值，计算权重和其信息熵
    #     print(y[features[0] == value])
